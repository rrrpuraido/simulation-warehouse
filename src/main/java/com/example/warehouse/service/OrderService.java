...
public class OrderService {
    ...
    private void processOrderPayment(Order order) {
        ...
        // Send email notification - this should be in a separate service
    ...
    private void handleOrderShipping(Order order) {
        ...
        // Shipping logic - this should be in a separate service
    ...
    private void handleOrderCompletion(Order order) {
        ...
        // Completion logic - this should be in a separate service
